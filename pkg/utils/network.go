...
//
// Sample input:  ip = net.ParseIP("192.168.1.10")
// Sample output: true
...
//
// Sample output: "192.168.1.20", nil
...
//
// Sample output: []net.IP{net.ParseIP("192.168.1.20"), net.ParseIP("10.0.0.5")}
