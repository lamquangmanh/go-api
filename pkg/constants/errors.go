...
var (
	...
	ErrInvalidEmailOrPassword  = ErrorDef{Code: 101, GrpcCode: codes.InvalidArgument, Message: "invalid email or password"}
	ErrAuthInternal            = ErrorDef{Code: 102, GrpcCode: codes.Internal, Message: "auth internal: %v"}
