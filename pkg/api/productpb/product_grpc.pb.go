...
const (
	ProductService_GetProduct_FullMethodName    = "/proto.product.v1.ProductService/GetProduct"
	ProductService_GetProducts_FullMethodName   = "/proto.product.v1.ProductService/GetProducts"
	ProductService_CreateProduct_FullMethodName = "/proto.product.v1.ProductService/CreateProduct"
	ProductService_UpdateProduct_FullMethodName = "/proto.product.v1.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName = "/proto.product.v1.ProductService/DeleteProduct"
)
...
type ProductServiceClient interface {
	...
	// Req example: { "product_id": "uuid" }
	// Res example: { product: { "product_id": "...", "name": "..." } }
	...
	CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateSuccess, error)
	// UpdateProduct updates a product
	// Req example: { "product": { "product_id":"uuid", "name":"new" }, "user_id":"uuid" }
	UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error)
	// DeleteProduct soft-deletes a product
	// Req example: { "product_id":"uuid", "user_id":"uuid" }
	DeleteProduct(ctx context.Context, in *DeleteProductRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error)
}
...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(basepb.UpdateSuccess)
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *DeleteProductRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(basepb.DeleteSuccess)
...
type ProductServiceServer interface {
	...
	// CreateProduct creates a product
	// Req example: { "product": { "name":"p" }, "user_id":"uuid" }
	CreateProduct(context.Context, *CreateProductRequest) (*CreateSuccess, error)
	// UpdateProduct updates a product
	// Req example: { "product": { "product_id":"uuid", "name":"new" }, "user_id":"uuid" }
	UpdateProduct(context.Context, *UpdateProductRequest) (*basepb.UpdateSuccess, error)
	// DeleteProduct soft-deletes a product
	// Req example: { "product_id":"uuid", "user_id":"uuid" }
	DeleteProduct(context.Context, *DeleteProductRequest) (*basepb.DeleteSuccess, error)
...
func (UnimplementedProductServiceServer) CreateProduct(context.Context, *CreateProductRequest) (*CreateSuccess, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateProduct not implemented")
}
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *UpdateProductRequest) (*basepb.UpdateSuccess, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateProduct not implemented")
}
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *DeleteProductRequest) (*basepb.DeleteSuccess, error) {
