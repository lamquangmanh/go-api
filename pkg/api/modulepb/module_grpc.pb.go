...
type ModuleServiceClient interface {
	...
	UpdateModule(ctx context.Context, in *UpdateModuleRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error)
	// DeleteModule soft-deletes a module
	// Req example: { "module_id":"uuid", "user_id":"uuid" }
	DeleteModule(ctx context.Context, in *DeleteModuleRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error)
}
...
func (c *moduleServiceClient) UpdateModule(ctx context.Context, in *UpdateModuleRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *moduleServiceClient) DeleteModule(ctx context.Context, in *DeleteModuleRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ModuleServiceServer interface {
	...
	// UpdateModule updates a module
	// Req example: { "module": { "module_id":"uuid", "name":"new" }, "user_id":"uuid" }
	UpdateModule(context.Context, *UpdateModuleRequest) (*basepb.UpdateSuccess, error)
	// DeleteModule soft-deletes a module
	// Req example: { "module_id":"uuid", "user_id":"uuid" }
	DeleteModule(context.Context, *DeleteModuleRequest) (*basepb.DeleteSuccess, error)
...
func (UnimplementedModuleServiceServer) UpdateModule(context.Context, *UpdateModuleRequest) (*basepb.UpdateSuccess, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateModule not implemented")
}
func (UnimplementedModuleServiceServer) DeleteModule(context.Context, *DeleteModuleRequest) (*basepb.DeleteSuccess, error) {
