...
func (x *GetModulesRequest) GetPagination() *basepb.PaginationRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetModulesRequest) GetSorts() []*basepb.Sort {
	if x != nil {
		return x.Sorts
	}
	return nil
...
func (x *GetModulesRequest) GetFilters() []*basepb.Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *GetModulesResponse) GetPagination() *basepb.PaginationResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetModuleResponse) GetErrors() []*basepb.ErrorMessage {
	if x != nil {
		return x.Errors
	}
	return nil
...
const file_proto_module_v1_module_proto_rawDesc = "" +
	...
	"\fDeleteModule\x12$.proto.module.v1.DeleteModuleRequest\x1a\x1c.proto.base.v1.DeleteSuccess\"\x00B\"Z go-api/pkg/api/modulepb;modulepbb\x06proto3"
