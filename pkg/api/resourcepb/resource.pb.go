...
type Action struct {
	...
	RequestType   actionpb.ActionRequestType `protobuf:"varint,3,opt,name=request_type,json=requestType,proto3,enum=proto.action.v1.ActionRequestType" json:"request_type,omitempty"`
...
func (x *Action) GetRequestType() actionpb.ActionRequestType {
	if x != nil {
		return x.RequestType
	}
	return actionpb.ActionRequestType(0)
}
...
func (x *GetResourcesRequest) GetPagination() *basepb.PaginationRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetResourcesRequest) GetSorts() []*basepb.Sort {
	if x != nil {
		return x.Sorts
	}
	return nil
...
func (x *GetResourcesRequest) GetFilters() []*basepb.Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *GetResourcesResponse) GetPagination() *basepb.PaginationResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetResourceResponse) GetErrors() []*basepb.ErrorMessage {
	if x != nil {
		return x.Errors
	}
	return nil
...
const file_proto_resource_v1_resource_proto_rawDesc = "" +
	...
	"\x0eDeleteResource\x12(.proto.resource.v1.DeleteResourceRequest\x1a\x1c.proto.base.v1.DeleteSuccess\"\x00B&Z$go-api/pkg/api/resourcepb;resourcepbb\x06proto3"
...
var file_proto_resource_v1_resource_proto_goTypes = []any{
	...
	(actionpb.ActionRequestType)(0),   // 12: proto.action.v1.ActionRequestType
