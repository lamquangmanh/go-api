...
type PermissionServiceClient interface {
	...
	UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error)
	// DeletePermission soft-deletes a permission
	// Req example: { "permission_id":"uuid", "user_id":"uuid" }
	DeletePermission(ctx context.Context, in *DeletePermissionRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error)
...
func (c *permissionServiceClient) UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...grpc.CallOption) (*basepb.UpdateSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *permissionServiceClient) DeletePermission(ctx context.Context, in *DeletePermissionRequest, opts ...grpc.CallOption) (*basepb.DeleteSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PermissionServiceServer interface {
	...
	// UpdatePermission updates a permission mapping
	// Req example: { "permission": { "permission_id":"uuid", ... }, "user_id":"uuid" }
	UpdatePermission(context.Context, *UpdatePermissionRequest) (*basepb.UpdateSuccess, error)
	// DeletePermission soft-deletes a permission
	// Req example: { "permission_id":"uuid", "user_id":"uuid" }
	DeletePermission(context.Context, *DeletePermissionRequest) (*basepb.DeleteSuccess, error)
	// GetPermissionsByUserId returns permissions available to a user
	// Req example: { "user_id":"uuid" }
	// Res example: { "permissions": [ { "resource": {...}, "action": {...} } ] }
...
func (UnimplementedPermissionServiceServer) UpdatePermission(context.Context, *UpdatePermissionRequest) (*basepb.UpdateSuccess, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePermission not implemented")
}
func (UnimplementedPermissionServiceServer) DeletePermission(context.Context, *DeletePermissionRequest) (*basepb.DeleteSuccess, error) {
